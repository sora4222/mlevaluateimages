...
from pipeline.ingestion import ingestion
from pipeline.configs import IMAGES_DIR
...
def create_pipeline(
  ...
  # Get the input TODO: Attach my data to the pipeline.
  example_gen = ingestion(records_path=Path(data_path), path_to_images=Path(IMAGES_DIR))
